...
namespace DaveBrownPhotography
{
    public partial class Band_Photography : PortfolioBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Denver, Colorado based band Photographer Dave Brown specializes in band, musician photography, and music portraits.";
