...
namespace DaveBrownPhotography
{
    public partial class Food_Photography : PortfolioBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Denver Food Photographer Dave Brown specializes in food photography, commercial photography, denver food photographer, food pictures denver.";
