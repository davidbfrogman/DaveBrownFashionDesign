...
namespace DaveBrownPhotography
{
    public partial class Wedding_Photography : PortfolioBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Denver, Colorado based wedding Photographer Dave Brown specializes in wedding, love photography, and wedding portraits.";
