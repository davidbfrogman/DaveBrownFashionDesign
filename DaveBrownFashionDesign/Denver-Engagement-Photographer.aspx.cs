...
namespace DaveBrownPhotography
{
    public partial class Engagement_Photography : PortfolioBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Denver Engagement Photographer Dave Brown specializes in engagement photographer, love photography, and engagement portraits, and engagement pictures.";
