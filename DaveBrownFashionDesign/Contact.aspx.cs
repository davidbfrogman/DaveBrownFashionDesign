...
namespace DaveBrownPhotography
{
    public partial class Contact : System.Web.UI.Page
    {
        ...
        {
            ((DaveBrownPhotoMaster)(this.Master)).PageTitle = "Contact Denver Photographer Dave Brown";
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Feel Free to contact Denver, Colorado based Photographer Dave Brown. Dave Brown is a Denver Portrait Photographer who specializes in Engagement, Senior Portraits, Commercial, Pet Portraits, and Fashion Photography.";
            ((DaveBrownPhotoMaster)(this.Master)).MetaKeywords = "denver photographer, denver engagement photographer, phototgrapher denver, contact, contact Dave Brown Photography";
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            lblSendConfirmation.Visible = true;
				...
				catch
				{
                    tblSendNote.Visible = false;
                    spnFeelFree.Visible = false;
					lblSendConfirmation.Text = "Boooo... I think the internets are broken again.  Can you please just send me an email at: info@davebrownphotography.com";
