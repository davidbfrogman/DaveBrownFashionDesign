...
namespace DaveBrownPhotography
{
    public partial class Commercial_Photography : PortfolioBasePage
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            ((DaveBrownPhotoMaster)(this.Master)).MetaDescription = "Denver Commercial Photographer Dave Brown is a Denver Portrait Photographer who specializes in headshots, product promotion images,and general photography.";
